...
* Use WASD to move the ship, R to rotate and T to place the ship after placing the 5 ships then enter the cordens to attak the oponents ships if you distroy all of the oponents ships befor he distroy yours then you win the game.
*/
